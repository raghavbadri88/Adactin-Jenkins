...
public class AdactinApplication {
	...
	public static void main(String[] args) throws InterruptedException {
		System.setProperty("webdriver.chrome.driver",
				"C:\\Users\\ragha\\eclipse-workspace\\AdactinJava\\Driver\\chromedriver.exe");
		...
		Thread.sleep(500);
		driver.findElement(By.id("datepick_in")).sendKeys("20/10/2020");
		Thread.sleep(500);
		driver.findElement(By.xpath("//*[@id=\"datepick_out\"]")).clear();
		Thread.sleep(500);
		driver.findElement(By.xpath("//*[@id=\"datepick_out\"]")).sendKeys("25/10/2020");
		Thread.sleep(500);
		...
		driver.findElement(By
				.xpath("/html/body/table[2]/tbody/tr[2]/td/form/table/tbody/tr[2]/td/table/tbody/tr[2]/td[1]/input[1]"))
				.click();
